...
- The [curl](https://jeroen.r-universe.dev/curl) package is needed for
  using [`unzip()`](https://r-lib.github.io/zip/reference/unzip.md) on
  URLs.
- Background processes,
  i.e. [`zip_process()`](https://r-lib.github.io/zip/reference/zip_process.md)
  and
...
[`zip()`](https://r-lib.github.io/zip/reference/zip.md) creates a new
ZIP archive. (It overwrites the output file if it exists.) Simply supply
all directories and files that you want to include in the archive.
...
[`zip_append()`](https://r-lib.github.io/zip/reference/zip.md) is
similar to [`zip()`](https://r-lib.github.io/zip/reference/zip.md), but
it appends files to an existing ZIP archive.

### Listing ZIP files

[`zip_list()`](https://r-lib.github.io/zip/reference/zip_list.md) lists
files in a ZIP archive. It returns a data frame:
...
[`unzip()`](https://r-lib.github.io/zip/reference/unzip.md) uncompresses
a ZIP archive:
...
[`zip_list()`](https://r-lib.github.io/zip/reference/zip_list.md) also
work on HTTP(S) URLs, without downloading the whole file. This needs the
